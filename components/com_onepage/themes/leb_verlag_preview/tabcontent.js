...
function onGuestPressed(el)
{
  Onepage.op_runSS(el, false, true, 'checkemail', false);
...
function onRegisterPressed(el)
{

Onepage.op_runSS(el, false, true, 'checkemail', false);
Onepage.op_runSS(el, false, true, 'checkusername', false);
