...
?>
  ...
  <div class="op_col1"><?php 
	...
	?></div>
    <div class="op_col2_2"><h3><?php echo $product['product_name']; ?></h3>
    ...
    <div class="op_col6"><div class="vertical_align"><div class="inside_v"><div class="qlabel">
	<span class="quantity_lb"><?php echo ''.'</span></div>'; 
	echo '<div class="ulabel2">'.$product['update_form'].'</div>'; ?>
		<?php echo '<div class="dlabel2">'.$product['delete_form'] ?></div></div></div></div>
...
?>
 <div class="opc_separator2">&nbsp</div>
<?php 
if (false)
{
