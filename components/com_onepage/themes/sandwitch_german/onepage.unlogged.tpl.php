...
<div class="opc_menu">
 <div class="menu_overflow"><div id="visitor_div" class="<?php if (!$show_login_first) echo 'opc_menu_active'; else echo 'opc_menu_inactive'; ?> opc_menu_item"><button onclick="return opc_menuClick('visitor');"><span class="opc_title"><?php echo $VISITOR_TEXT; ?></span></button></div><div id="visitor_arrow" class="arrow_visitor" <?php if ($show_login_first) echo ' style="display: none;" '; ?>><div class="opc_arrow_white">&nbsp;</div><div class="opc_arrow">&nbsp;</div></div>
 </div>
 
 <div class="menu_overflow" <?php if (!empty($hide_business_tab)) echo ' style="display: none;" '; ?> >
 <div class="opc_menu_inactive opc_menu_item" id="business_div" style="margin-top: 10px;"><button onclick="return opc_menuClick('business');"><span class="opc_title"><?php echo $BUSINESS_TEXT; ?></span></button></div><div id="business_arrow" class="arrow_business" style="display: none;"><div class="opc_arrow_white">&nbsp;</div><div class="opc_arrow">&nbsp;</div></div>
 </div>


 
 <div class="menu_overflow" <?php if ($no_login_in_template) echo ' style="display: none;" '; ?> >
 <div class="<?php if ($show_login_first) echo 'opc_menu_active'; else echo 'opc_menu_inactive'; ?> opc_menu_item" id="login_div" style="margin-top: 10px;"><button onclick="return opc_menuClick('login');"><span class="opc_title"><?php echo OPCLang::_('COM_VIRTUEMART_LOGIN'); ?></span></button></div><div id="login_arrow" class="arrow_login" style="<?php if (!$show_login_first) echo ' display: none; '; ?>"><div class="opc_arrow_white">&nbsp;</div><div class="opc_arrow">&nbsp;</div></div>
 </div>
...
<input value="1" type="checkbox" id="agreed_field" name="tosAccepted" <?php if (!empty($agree_checked)) echo ' checked="checked" '; ?> class="terms-of-service"  required="required" autocomplete="off" />
	...
	<div style="width: 95%; float:left;">
					<label for="agreed_field" style="white-space: normal;"><span class="agree_text"><?php echo OPCLang::_('COM_VIRTUEMART_I_AGREE_TO_TOS').'</span>';  
					if (!empty($tos_link))
					{
