...
';
			...
			if ($isPlaceholder) {
			$field['formcode'] = str_replace('type="', ' alt="'.$field['title'].'" title="'.$field['title'].'" placeholder="'.$field['title'].'" type="', $field['formcode']); 
			} else {
			$field['formcode'] = str_replace('type="', ' alt="'.$field['title'].'" title="'.$field['title'].'" type="', $field['formcode']); 
			}
			//if (empty($opc_rtl))
			{
