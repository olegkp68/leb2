...
<div id="basket_container">
	<div id="basket_cart">
		<div id="cart_header" class="vmsectiontableheader">
			...
			<div class="op_col5 hide_column"><?php echo OPCLang::_('COM_VIRTUEMART_CART_PRICE') ?></div>
			<div class="op_col6 hide_column"><?php echo OPCLang::_('COM_VIRTUEMART_CART_QUANTITY') ?> / <?php echo OPCLang::_('COM_VIRTUEMART_CART_ACTION') ?></div>
			<div class="op_col7_header"><?php echo OPCLang::_('COM_VIRTUEMART_CART_SUBTOTAL') ?></div>
		</div>
		<div id="cart_products">
			...
			<div  class="cart_prod <?php echo $product['row_color'] ?>">
				...
				<div class="op_col1 hide_column"><?php $img = $this->op_show_image($product['product_full_image'], '', 40, 40, 'product'); 
				echo $img; 
				if (($img == '&nbsp;') || (empty($img)))
				 {
				   $css = '#vmMainPageOPC div.cart_prod div.op_col1 { 
				      display: none; 
					}
					div#vmMainPageOPC div#basket_container div.cart_prod div.op_col4 {
					 width: 16%; 
					}
					'; 
...
<?php 
 ...
 ?> 
  ...
  <div class="vmsectiontableentry2" id="tt_total_basket_div_basket">
	...
	<div class="discount_desc" id="tt_total_basket"><?php echo $order_total_display ?></div>
  </div>
