...
<form action="<?php echo $action_url; ?>" method="post" name="adminForm" class="form-va2lidate" novalidate="novalidate">
<!-- user info details -->
<div class="btandst">
<div class="<?php if (empty($no_shipto)) echo 'no_shipto'; ?>bt_left">
...
<textarea placeholder="<?php echo $comment; ?>" name="customer_note" id="customer_note_field"></textarea>
</div>
</div>
</fieldset>
...
<?php if (!empty($opc_rtl)) echo '<div style="display: none;">';  
?>
<div id="totalam">
