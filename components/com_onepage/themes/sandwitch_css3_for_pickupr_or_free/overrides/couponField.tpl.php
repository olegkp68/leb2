...
?>  
	...
	<div class="field_wrapper coupon_wrapper">
	<div class="coupon_text_field">
	<div class="formField">
    <input type="text" name="coupon_code" id="coupon_code" size="20" class="coupon_input" alt="<?php echo $this->coupon_text ?>" placeholder="<?php echo $this->coupon_text; ?>" />
	</div>
	</div>
