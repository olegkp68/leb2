	   	...
	   	foreach( $rowFields['fields'] as $field) {
			...
			&& (!defined('REGBUTTON')))
			{
				...
				echo '<div class="formLabel" id="register_label">
						...
						echo '" onclick="javascript: return showSAreg(this);" autocomplete="off" ><div class="chckbx" style="float: left;">&nbsp;</div><div id="register_span" class="register_span">'.OPCLang::_('COM_VIRTUEMART_ORDER_REGISTER').'</div></button>
					</div>
				<div class="formField">
	   		...
	   		switch( $field['name'] ) {
				...
				case 'password2':
					...
					echo $field['formcode']; 
		   			break;
				case 'socialNumber':
					echo str_replace('name="', ' autocomplete="off" name="', $field['formcode']); 
