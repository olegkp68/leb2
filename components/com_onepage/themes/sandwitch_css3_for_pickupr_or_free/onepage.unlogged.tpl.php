...
<div class="opc_menu">
 <div class="menu_overflow"><div id="visitor_div" class="opc_menu_active opc_menu_item"><button onclick="return opc_menuClick('visitor');"><span class="opc_title"><?php echo $VISITOR_TEXT; ?></span></button></div><div id="visitor_arrow" class="arrow_visitor"><div class="opc_arrow_white">&nbsp;</div><div class="opc_arrow">&nbsp;</div></div>
 </div>
	  ...
	  <div class="opc_inside">
		<div>
		   <div class="field_wrapper">
			...
			<?php } ?>
			<div class="formField">
			  <input type="text" id="username_login" name="username_login" class="inputbox" size="20" autocomplete="off" placeholder="<?php echo OPCLang::_('COM_VIRTUEMART_USERNAME'); ?>" alt=="<?php echo OPCLang::_('COM_VIRTUEMART_USERNAME'); ?>" title="<?php echo OPCLang::_('COM_VIRTUEMART_USERNAME'); ?>" />
			</div>
			</div>
			<div class="field_wrapper">
			<?php if (false) { ?>
			...
			<div class="formField">
				...
				?>" class="inputbox" size="20" onkeypress="return submitenter(this,event)"  autocomplete="off" placeholder="<?php echo OPCLang::_('COM_VIRTUEMART_SHOPPER_FORM_PASSWORD_1'); ?>" alt="<?php echo OPCLang::_('COM_VIRTUEMART_SHOPPER_FORM_PASSWORD_1'); ?>" title="<?php echo OPCLang::_('COM_VIRTUEMART_SHOPPER_FORM_PASSWORD_1'); ?>" />
			</div>
			</div>
	<?php 
	if (false)
