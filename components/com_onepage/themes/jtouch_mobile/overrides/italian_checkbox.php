...
<div style="width: 100%; margin: 0;" id="italian_checkbox">

<script type="text/javascript">
if (typeof op_userfields != 'undefined')
op_userfields.push('italianagreed'); 
if (typeof custom_rendering_fields != 'undefined')
...
<label for="italianagreed_field" style="float: none; white-space: normal;"><span style="font-weight:bold;"><?php echo OPCLang::_('COM_ONEPAGE_ITALIAN_AGREE_LABEL').'</span><br />'; 
