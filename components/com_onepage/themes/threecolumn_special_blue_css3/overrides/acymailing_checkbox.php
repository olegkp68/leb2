...
<input type="hidden" name="allVisibleLists" value="<?php echo $opc_acy_id; ?>" />
					...
					<div class="right_label" ><label for="acy_list_<?php echo $opc_acy_id; ?>" style="float: none; white-space: normal;"><span style="font-weight:bold;"><?php echo OPCLang::_('COM_VIRTUEMART_FIELDS_NEWSLETTER'); ?></span><br />
					<?php
