...
<input value="1" type="checkbox" id="italianagreed_field" name="italianagreed" <?php if (!empty($agree_checked)) echo ' checked="checked" '; ?> class="terms-of-service required"  required="required" autocomplete="off" />
					...
					<div class="acy_label_wrapper" ><label for="italianagreed_field" style="float: none; white-space: normal;max-width: 90%;"><span style="font-weight:bold;"><?php echo OPCLang::_('COM_ONEPAGE_ITALIAN_AGREE_LABEL').'</span><br />'; 
