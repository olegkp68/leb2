...
<div id="register_box" <?php
	...
	<div class="formField3" id="registerbtnfield" >
	<input type="button" name="RegisterSubmit" class="submitbtn bandBoxRedStyle" value="<?php echo OPCLang::_('COM_ONEPAGE_CREATEACCOUNT'); ?>" onclick="return onRegisterPressed(this, event); " />
	</div>
	</div>
</div>
<div id="login_box" <?php 
	...
	<div id="login_container"><span><?php echo OPCLang::_('COM_ONEPAGE_LOGIN_TEXT'); ?></span>
			...
			<div class="formField3" >
				...
				?>" class="inputbox" size="20" onkeypress="return submitenter(this,event)"  autocomplete="off" placeholder="<?php echo OPCLang::_('COM_VIRTUEMART_SHOPPER_FORM_PASSWORD_1') ?>" />
			</div>
...
<div id="guest_head" class="bandBoxStyle"><?php echo OPCLang::_('COM_ONEPAGE_REGISTER_AND_CHECKOUT'); ?></div>
 <div id="guest_container"><span><?php echo OPCLang::_('COM_ONEPAGE_GUEST_TEXT'); ?></span>
	...
	<div class="formField3">
		<input type="email" id="guest_email" name="guest_email" class="inputbox" size="20" autocomplete="off" onblur="javascript: Onepage.email_check(this, event);" onkeyup="syncEmails(this);" <?php 
		
		if (!empty($cart->BT['email'])) echo ' value="'.$cart->BT['email'].'"'; 
		
		?> placeholder="<?php echo OPCLang::_('COM_VIRTUEMART_EMAIL'); ?>" />
	</div>
	<div class="formField3" id="guestbtnfield" >
		<input type="button" name="GuestSubmit" class="submitbtn bandBoxRedStyle" value="<?php echo OPCLang::_('COM_ONEPAGE_SUBMIT'); ?>" onclick="return onGuestPressed(this, event); " />
	</div>
</div>
	</div>
</div>
...
<div id="payment_box" class="bandbox_wrapper">
	<div id="payment_head" class="bandBoxStyle bandBoxStyleHeader"><?php echo OPCLang::_('COM_VIRTUEMART_CART_PAYMENT'); ?></div>
...
?><div class="acy_wrapper">
	<div id="agreed_div2" class="acy_checkbox_wrapper " >
