...
<div class="black-basket cart-summary">
  ...
  <div class="right-link">
    <div class="back-to-category">
        <a href="<?php echo $continue_link ?>" class="button_back button reset2" title="<?php echo $categoryName ?>"><i class="fa fa-reply"></i><?php echo OPCLang::_('COM_VIRTUEMART_CONTINUE_SHOPPING'); ?></a>
    </div>
  </div>
  <?php } ?>
...
?>
  <div class="op_basket_row op_basket_rows section<?php echo $i ?> set">
    ...
    <div class="op_col5"><div class="overr"><?php echo $basePrice; ?></div><?php echo $product['product_price'] ?>&nbsp;</div>
...
?>
 ...
 <div class="op_basket_row custom_chec" <?php if (empty($discount_before)) echo ' style="display: none;" '; ?> id="tt_order_discount_before_div_basket">
  ...
  <div class="op_basket_row custom_chec"  id="tt_tax_total_0_div_basket" style="<?php if (empty($tax_display)) echo 'display: none;'; ?>" >
  ...
  <div class="op_basket_row totals dynamic_lines custom_chec"  id="tt_genericwrapper_basket" style="display: none;">
        <div class="op_col1_4 dynamic_col1"   >{dynamic_name}: </div>
        <div class="op_col5_3 dynamic_col2"   >{dynamic_value}</div>
  </div>
  
  <div class="op_basket_row custom_chec total">
    <div class="op_col1_4" align="right">
<?php echo $op_coupon; echo OPCLang::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?>: </div>
