...
$varname = 'COM_VIRTUEMART_CHECKOUT_MSG_' . CHECK_OUT_GET_SHIPPING_ADDR;
//echo '<h4>'. OPCLang::_($varname) . '</h4>';
?>
</div>
<!-- Customer Ship To -->
