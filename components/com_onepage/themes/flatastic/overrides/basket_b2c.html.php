...
<table width="100%" cellspacing="0" cellpadding="4" border="0" style="border:1px solid #BEBCB7;margin-bottom:10px;">
  ...
  <tr align="left" >
        <th class="vmsectiontableheader"><?php echo OPCLang::_('COM_VIRTUEMART_CART_NAME') ?></th>
	...
	<th class="vmsectiontableheader"><?php echo OPCLang::_('COM_VIRTUEMART_CART_SUBTOTAL') ?></th>
  </tr>
...
<!--Begin of SubTotal, Tax, Shipping, Coupon Discount and Total listing -->
  <tr class="vmsectiontableentry1">
    <td colspan="4" align="right"><?php echo OPCLang::_('COM_VIRTUEMART_CART_SUBTOTAL') ?>:</td> 
    <td colspan="3" align="right"><?php echo $subtotal_display ?></td>
  </tr>
<?php if( $discount_before ) { ?>
  <tr class="vmsectiontableentry1">
    <td colspan="4" align="right"><?php echo OPCLang::_('COM_VIRTUEMART_COUPON_DISCOUNT') ?>:
    </td> 
...
if( $shipping ) { ?>
  <tr class="vmsectiontableentry1">
	<td colspan="4" align="right"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_PRINT_SHIPPING') ?>: </td> 
...
<?php } ?>
  ...
  <tr>
    <td class="vmsectiontableentry2"colspan="4" align="right"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?>: </td>
    <td class="vmsectiontableentry2"colspan="3" align="right"><strong><?php echo $order_total_display ?></strong></td>
  </tr>
<?php if ( $show_tax ) { ?>
  <tr class="vmsectiontableentry1">
        <td colspan="4" align="right" valign="top"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL_TAX') ?>: </td> 
