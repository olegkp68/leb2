...
<div style="width: 100%;" class="acy_class_wrapper agree_top_wrapper">
...
<input type="hidden" name="allVisibleLists" value="<?php echo $opc_acy_id; ?>" />
					...
					<div class="agreed_label_wrapper" ><label for="acy_list_<?php echo $opc_acy_id; ?>" style="float: none; white-space: normal;"><span style="font-weight:bold;"><?php echo OPCLang::_('COM_VIRTUEMART_FIELDS_NEWSLETTER'); ?></span><br />
					<?php
