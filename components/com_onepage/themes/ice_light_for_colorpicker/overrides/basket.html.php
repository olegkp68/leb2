...
<div class="black-basket" style="float: left;">
  ...
  <div class="op_basket_row op_basket_header">
    ...
    <div class="op_col7_1"><?php echo OPCLang::_('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?></div>
	<div class="op_col7_2"><?php echo OPCLang::_('COM_VIRTUEMART_CART_SUBTOTAL') ?></div>
  </div>
<?php 
...
?>
  <div class="op_basket_row">
    ...
    <div class="op_col5"><?php echo $basePrice; ?> </div>
    <div class="op_col6"><?php echo $product['update_form'] ?>
		<?php echo $product['delete_form']; 
		?>&nbsp;</div>
	<div class="op_col7_1"><?php echo $discount; ?>&nbsp;</div>	
    <div class="op_col7_2"><?php echo $product['subtotal'];?>&nbsp;</div>
  </div>
<?php } ?>
