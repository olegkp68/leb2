...
<!-- end show TOS and checkbox before button -->
 ...
 <div id="confirmbtn_area">
	<button id="confirmbtn_button" type="submit" autocomplete="off" <?php echo $op_onclick; ?> ><span class="op_round"><span id="confirmbtn" class="inspan" style="width: 250px;"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_CONFIRM_MNU') ?></span></span></button>
 </div>
<br style="clear: both;"/>
</div>
