...
?></div>
  <div class="opc_inside" id="idsa" style="<?php if (empty($op_shipto_opened)) echo 'display: none;' ?>">
    <div>
	<div style="display: none;"><input type="checkbox" <?php if (!empty($op_shipto_opened)) echo 'checked="checked" '; ?>  name="sa" value="adresaina" id="sachone" autocomplete="off" /><?php echo OPCLang::_('COM_VIRTUEMART_USER_FORM_ADD_SHIPTO_LBL');  ?></div> 
