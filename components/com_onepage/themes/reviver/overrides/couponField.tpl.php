...
?>  
    ...
    <input type="text" name="coupon_code" id="coupon_code" size="20" class="coupon coupon_input input-large" alt="<?php echo $this->coupon_text ?>" value="<?php echo $this->coupon_text; ?>" onblur="if(this.value=='') this.value='<?php echo $this->coupon_text; ?>';" onfocus="if(this.value=='<?php echo $this->coupon_text; ?>') this.value='';" />
	</div>
