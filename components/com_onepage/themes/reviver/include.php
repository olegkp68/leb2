...
JHTMLOPC::stylesheet('custom.css', 'components/com_onepage/themes/'.$selected_template, array());
...
JHTMLOPC::script('jquery.formstyler.min.js', 'components/com_onepage/themes/'.$selected_template, false);
