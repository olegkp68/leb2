...
?>
  <div class="op_basket_row">
    ...
    <div class="op_col2_2"><?php echo $product['product_name']; ?>
	  <div class="product_attributes">
		<?php echo 	$product['product_attributes'] ?>
	  </div>
     <div class="desc_title" style=""> <?php $mfeatures = JText::_('COM_VIRTUEMART_CART_MAIN_FEATURES'); 
		 if ($mfeatures != 'COM_VIRTUEMART_CART_MAIN_FEATURES') echo $mfeatures; 
	 ?> </div> 
    ...
    <div class="op_col5 unit_column"><?php echo $product['product_price'] ?>&nbsp;</div>
   	<div class="op_col6 quantitycol"><?php echo $product['update_form'] ?>
...
echo $op_coupon_ajax; // will show coupon if enabled from common/couponField.tpl.php with corrected width to size 
?>
					
<div class = "col-module_fix">			


<div id="subtotal_box2" <?php if(empty($op_coupon)) echo 'style="width:98%;"'; ?>>

<div id="subtotal_container2">
...
?>
  <div class="op_basket_row" >
    ...
    <div><?php echo $payment_select; ?></div>
	</div>
...
?>
 <div class="op_basket_row" <?php if (empty($discount_before)) echo ' style="display: none;" '; ?> id="tt_order_discount_before_div_basket">
  ...
  <div class="op_basket_row bsep" style="">
  </div>
  ...
  <div class="op_basket_row" >
    ...
    <div class="op_col5_3" id="tt_total_basket"><?php echo $order_total_display ?></div>
  </div>
</div>
