...
<div class="black-basket" style="float: left;">
            ...
            <div class="col-module_fix" style="float: left;">                                      
                             ...
                             <h3>
                                ...
                                <span class="col-module_header_color cart_header_span"><?php echo OPCLang::_('COM_VIRTUEMART_CART_TITLE'); ?></span>
                                </span>
                                </span>
                             	</span>  
                        	</h3>
  ...
  <div class="op_basket_header op_basket_row">
    ...
    <div class="op_col6"><span class="quantity_label"><?php echo OPCLang::_('COM_VIRTUEMART_CART_QUANTITY') ?> / <?php echo OPCLang::_('COM_VIRTUEMART_CART_ACTION') ?></span>&nbsp;</div>
...
?>
  ...
  ?>">
    <div class="op_col2_2">
	<div class="name_and_image_wrap">
	<div class="product_name_in_cart">
	<?php echo $product['product_name']; ?>
	</div>
	</div>
	
	
	<div class="product_image_in_cart" style="display: none;">
	<?php 
	echo $this->op_show_image($product['product_full_image'], '', 0, 30, 'product'); 
	?></div>
	
   <div class="product_attributes_in_cart">
   <?php
