...
?>  
	...
	<button id="submit_coupon_button" type="submit"><span class="op_round" id="span_coupon_button" style="width: 150px;"><span style="width: 110px;"><span class="inspan"><?php echo OPCLang::_('COM_VIRTUEMART_SAVE'); ?></span></span></span></button>
