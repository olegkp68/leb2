...
';
		  ...
		  echo '>'."\n";
			...
			switch($field['type']) {
				 case 'select':
				 case 'selectsingle':
				   $field['formcode'] = str_replace('class="', 'class="uk-width-1-1 uk-margin-small input-select ', $field['formcode']); 
				 break; 
				 case 'password':
				  $field['formcode'] = str_replace('autocomplete="', 'autocomplete="new-password ', $field['formcode']); 
				 break;
			 }
