...
<input type="submit" value="<?php echo OPCLang::_('COM_VIRTUEMART_ORDER_CONFIRM_MNU'); ?>" id="confirmbtn" class="uk-button uk-button-primary uk-button-large uk-margin-top uk-width-1-1" <?php echo $op_onclick ?> />
</div>	
</div>
<br style="clear: both;"/>
</div>
