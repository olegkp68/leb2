	 ...
	 
	{
		...
		$z = -1; 
		   ...
		   if (empty($field['required']))
			...
			$field['formcode_orig'] = $field['formcode']; 
	      	 ...
	      	 */
	   		...
	   		switch( $field['name'] ) {
				...
				case 'phone_1': 
						...
						$field['title'] .= ' - DHL will send you parcel updates'; 
						$formcode2 = str_replace('type="', ' title="'.$field['title'].'" alt="'.$field['title'].'" placeholder="'.$field['title'].'" type="', $field['formcode_orig']); 
					...
					*/
					...
					echo '<div class="country_wrap"><div class="country_label">'.$field['title'].'</div>'.$field['formcode'].'</div>';
	   				break;
