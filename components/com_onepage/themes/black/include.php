...
JHTMLOPC::stylesheet('basket.css', 'components/com_onepage/themes/'.$selected_template, array());
...
//JHTMLOPC::stylesheet('marcin.css', 'components/com_onepage/themes/'.$selected_template, array());
JHTMLOPC::stylesheet('newbasket.css', 'components/com_onepage/themes/'.$selected_template, array());
//JHTMLOPC::stylesheet('temp.css', 'components/com_onepage/themes/'.$selected_template, array());
JHTMLOPC::stylesheet('site.css', 'components/com_onepage/themes/'.$selected_template, array());
JHTMLOPC::stylesheet('mobile.css', 'components/com_onepage/themes/'.$selected_template, array());