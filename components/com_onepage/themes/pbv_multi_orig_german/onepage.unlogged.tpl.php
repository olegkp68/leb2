...
?><h1><?php echo OPCLang::_('COM_VIRTUEMART_CART_TITLE'); ?>&<?php echo OPCLang::_('COM_VIRTUEMART_ORDER_REGISTER_GUEST_CHECKOUT'); ?></h1>
	...
	<?php if (empty($no_login_in_template) && (VM_REGISTRATION_TYPE != 'NO_REGISTRATION')) { ?>
		<div id="logintab" class="tabcontent3" style="display: none;">
	      ...
	      <div class="wrap_login" style="float: none;">
	    	<div class="formLabel"><?php if(!$isPlaceholder) echo '<label>'.OPCLang::_('COM_VIRTUEMART_USERNAME').'</label>';?></div>	
			<div class="formField">
			...
			<div class="formLabel"><?php if(!$isPlaceholder) echo '<label>'.OPCLang::_('COM_VIRTUEMART_SHOPPER_FORM_PASSWORD_1').'</label>';?></div>
			<div class="formField">
...
<?php } ?>
	<div id="agreed_div"  class=" ">
		...
		<input type="checkbox" id="agreed_field" name="agreed" value="1" class="inputbox" <?php if (!empty($agree_checked)) echo ' checked="checked" '; ?> class="terms-of-service"  required="required" autocomplete="off" />
					...
					<div class="checkbox_div_right">
					<label for="agreed_field"><?php echo OPCLang::_('COM_VIRTUEMART_I_AGREE_TO_TOS'); ?></label>
					<?php if (!empty($tos_link)) JHTMLOPC::_('behavior.modal', 'a.opcmodal'); 
