...
$viewData['VPID'] = $method->virtuemart_paymentmethod_id; 
?>
...
/* <![CDATA[ */
			...
			function setStripeVals(stripeField, vmField, vmField2) {
				var d = document.getElementById('stripe_'+stripeField); 
				if (d !== null) {
					var dv = document.getElementById(vmField+'_field'); 
					if (dv !== null) {
						
						if (typeof dv.selectedIndex !== 'undefined') {
							var vm1 = dv.options[dv.selectedIndex].text;
							var vm2 = ''; 
						}
						else {
						...
						var vm1 = dv.value; 
						var vm2 = ''; 
						if ((typeof vmField2 !== 'undefined') && (vmField2)) {
							var dv2 = document.getElementById(vmField2+'_field'); 
							if (dv !== null) {
							  vm2 = ' '+dv2.value; 
							}
...
function opc_createToken(wasValid)
     {
		 ...
		 setStripeVals('name', 'first_name', 'last_name'); 
		 setStripeVals('address_1', 'address_1'); 
		 setStripeVals('address_2', 'address_2'); 
		 setStripeVals('city', 'city'); 
		 setStripeVals('zip', 'zip'); 
		 setStripeVals('city', 'city'); 
		 setStripeVals('country', 'virtuemart_country_id'); 
		 setStripeVals('state', 'virtuemart_state_id'); 
		 
		 //console.log('Stripe opc_createToken '); 
	   var rt = true; 
       jQuery(function($) {
