...
if ((empty($this->params->dual_mode)) || (($this->params->dual_mode === 1) && ($this->order['details']['BT']->country_3_code === 'CZE')) || (($this->params->dual_mode === 2) && ($this->order['details']['BT']->user_currency_code_3 === 'CZK') ))
{
...
if ((typeof console != 'undefined')  && (typeof console.log != 'undefined')  &&  (console.log != null))
	  {
	     console.log('OPC Tracking: Heureka.cz, meranie konverzii.'); 
	  }
...
if ((typeof console != 'undefined')  && (typeof console.log != 'undefined')  &&  (console.log != null))
	  {
	     console.log('OPC Tracking: Heureka.cz, overeno zakazniky.'); 
	  }
</script><?php 
    /**
