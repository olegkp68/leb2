...
<?php 
 $this->params->tag_event = 'fireRemarketingTag';
 include_once(JPATH_SITE.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_onepage'.DIRECTORY_SEPARATOR.'trackers'.DIRECTORY_SEPARATOR.'php'.DIRECTORY_SEPARATOR.'GA'.DIRECTORY_SEPARATOR.'datalayer_impressions.php'); 
?>
...
<img height="1" width="1" style="border-style:none;" alt="" src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/<?php echo $this->params->google_conversion_id; ?>/?value=<?php echo $order_total; ?>&oid=<?php echo (int)$this->order['details']['BT']->virtuemart_order_id; ?>&guid=ON&script=0&currency=<?php echo $this->order['details']['BT']->currency_code_3; ?>" />
</div>
</noscript>
...
<script>
	  ...
	  {
	     console.log('OPC Tracking: Adword GTM conversion remarketing tracking initialized'); 
	  }
</script>