...
/**
 * Class CustomfieldsForAllFilter
 *
 * This class is used for filtering the inputs in the custom field values
 * It extends the InputFilter class of Joomla
 *
 * @since    1.0
 */
class CustomfieldsForAllFilter extends InputFilter
{
    ...
    /**
     * Instanciates the class and returns a singleton
     *
     ...
     * @param int $xssAuto
     * @param int $stripUSC
     * @return CustomfieldsForAllFilter
     * @since 1.0
     */
    ...
    /**
     * Clean the passed variable (e.g. color)and return a valid one
     *
     * @param mixed $source
     * @param string $type
     * @return mixed|string
    ...
    public function clean($source, $type = 'string')
    {
        ...
        switch (strtoupper($type)) {
            ...
            case 'COLOR_HEX-ARRAY':
                if (is_array($source)) {
                    foreach ($source as $s) {
                        $string = (string)strtolower($s);
                        $res = $this->clean($string, 'COLOR_HEX');
                    }
                    if (!empty($res)) {
     ...
     *
     * @param string $string
     * @return    false|string color on suceess
     * @since 1.0
     */
    public function checkNFormatColor($string)
    {
        ...
        if (isset($this->standard_colors[$string])) {
            $result = $string;
        } else {
            $result = false;
        }
