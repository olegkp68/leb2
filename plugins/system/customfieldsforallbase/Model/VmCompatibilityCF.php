 ...
 * @copyright	Copyright (c) 2014-2020- 2014-2020breakdesigns.net. All rights reserved.
...
class VmCompatibilityCF extends \JObject
{
	public static $vmcompatibility = null;
	private $_tableColumns=array();

	public $vm3_table_columns = array(
	...
	public static function getInstance(){
		if(!self::$vmcompatibility){
			self::$vmcompatibility=new VmCompatibilityCF();
		}
