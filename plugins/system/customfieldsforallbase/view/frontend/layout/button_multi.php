...
<div class="<?php echo $wrapper_class?> cf4all_buttons" id="<?php echo $wrapper_id?>">
    <?php
    if($required):?>
    ...
    foreach ($options as $key=>$v) {
        ...
        <div class="inline-control-group cf4all-relative <?php echo $compatibilityClass?>">
            ...
            <label class="cf4all_button cf4all_no_color_btn <?php echo $class?>" for="<?php echo $input_id?>">
                <?php echo $label?>
            </label>
