...
//		$this->addvalidOrderingFieldName(array('ju.username','ju.name','ju.email','sg.virtuemart_shoppergroup_id','shopper_group_name','shopper_group_desc','vmu.virtuemart_user_id') );
		$this->addvalidOrderingFieldName(array('ju.username','ju.name','ju.email','ju.lastvisitDate','sg.virtuemart_shoppergroup_id','shopper_group_name','shopper_group_desc','vmu.virtuemart_user_id', 'is_online') );
	...
	*/
	...
	function getUserList() {
		...
		$select = ' ju.id AS id
			...
			, ju.email AS email
			, ju.lastvisitDate AS lastvisitDate
		, IF((SELECT DISTINCT userid FROM #__session WHERE userid = ju.id), 1 , 0) as is_online
