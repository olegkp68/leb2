 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class Numbers_Words_sk extends Numbers_Words
{
    ...
    var $_exponent = array(
       ...
       12 => array('bilión','bilióny','biliónov'),
       15 => array('biliarda','biliardy','biliárd'),
       18 => array('trilión','trilióny','triliónov'),
       21 => array('triliarda','triliardy','triliárd'),

       24 => array('kvadrilión','kvadrilióny','kvadriliónov'),
       30 => array('kvintilion','kvintiliony','kvintilionov'),
       36 => array('sextilion','sextiliony','sextilionov'),
       42 => array('septilion','septiliony','septilionov'),
    ...
    function toWords($num, $power = 0, $powsuffix = '')
    {
        ...
        if ($h) {
            ...
            if ($h == 1) {
                ...
                $ret .= $this->_sep . "dve" . $this->_sep . $this->_hundreds[1];
            } elseif ( ($h > 1) && ($h < 5) ) {
        ...
        case 3:
        	...
        	break;
        case 4:
            $ret .= $this->_sep . $this->_digits[$t] . 'dcať';
            break;
        ...
        case 1:
            ...
            case 1:
                $ret .= $this->_sep . 'jedenácť';
                break;

            case 4:
                $ret .= $this->_sep . 'štrnácť';
                break;

            case 5:
                $ret .= $this->_sep . 'pätnácť';
                break;

            case 9:
                $ret .= $this->_sep . 'devätnácť';
                break;
            ...
            case 7:
            case 8:
                $ret .= $this->_sep . $this->_digits[$d] . 'nácť';
                break;
            }
            break;
        }
