...
class ModuleRenderer extends DocumentRenderer
{
	...
	public function render($module, $attribs = array(), $content = null)
	{
		...
		if ($params->get('cache', 0) == 1 && \JFactory::getConfig()->get('caching') >= 1 && $cachemode != 'id' && $cachemode != 'safeuri')
		{
			...
			$contents =  ModuleHelper::ModuleCache($module, $params, $cacheparams);
		}
		else {
			$contents = ModuleHelper::renderModule($module, $attribs);
		}
		
		$name = $bench['name'] = $module->module;
