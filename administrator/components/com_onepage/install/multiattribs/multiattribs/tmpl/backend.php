...
<div class="<?php echo $span; ?> mt_input_div">Attribute Name</div>
<?php 

foreach ($cs as $c) { 
  
  $csa[$c->virtuemart_currency_id] = $c->virtuemart_currency_id; 
  ?> <div class="<?php echo $span; ?> mt_input_div"><?php echo $c->currency_code_3; ?> </div>  <?php
}

?>
<div class="mt_clear" ></div>
...
<div class="<?php echo $span; ?> mt_input_div"><input class="mt_input mt_first" type="text" name="<?php echo $name; ?>[{n}][attrib]"  value="{value_{n}_attrib}" placeholder="Attribute Name" /></div>
<?php 

foreach ($cs as $c) { 
  
  $csa[$c->virtuemart_currency_id] = $c->virtuemart_currency_id; 
  ?> <div class="<?php echo $span; ?> mt_input_div"><input class="mt_input " type="text" name="<?php echo $name; ?>[{n}][currency_price_<?php echo $c->virtuemart_currency_id; ?>]" value="{value_{n}_<?php echo $c->virtuemart_currency_id; ?>}" placeholder="Price addition (<?php echo $c->currency_code_3; ?>)" /> </div>  <?php
}

?><a href="#" class="add_more add_more_class_{n} more_class_hidden" rel="append_to_table_<?php echo $id; ?>" id="prefix<?php echo $id; ?>_{n}" onclick="return addMore(this, rowIns<?php echo $id; ?>);" current_id="<?php echo $id; ?>">Add More</a>
<div class="mt_clear" ></div>
...
$js = '
/*<![CDATA[*/
if (typeof rowIns'.$id.' == \'undefined\') rowIns'.$id.' = []; 
