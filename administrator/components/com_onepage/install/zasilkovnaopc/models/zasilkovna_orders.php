...
// 		vmdebug('getOrder my order',$order);
	...
	*/
	...
	public function getOrdersListByShipment($shipment_id = 0){
		...
		$db = JFactory::getDBO();
		$db->setQuery("SELECT order_number FROM #__virtuemart_shipment_plg_zasilkovna");
 ...
 public static function setVMLANG() {
	...
	self::setVMLANG(); 
		return ' FROM #__virtuemart_orders as o
			...
			RIGHT JOIN #__virtuemart_shipment_plg_zasilkovna as plg ON plg.order_number=o.order_number
