		...
		<?php
			...
			if (isset($this->product->customfields)) {
				...
				foreach ($this->product->customfields as $k=>$customfield) {
					...
					$customfield->virtuemart_custom_id = (int)$customfield->virtuemart_custom_id; 
					if (in_array($customfield->virtuemart_custom_id, $shipping_ids)) {
						$customfield->display = '</td><td>Edit this value at the first tab'; 
					}
