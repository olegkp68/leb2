...
<div class="zasielka_div1" style="padding-top: 8px; clear:both; <?php if ($viewData['sind'] != $branch->id) echo ' display: none;'; ?>" id="ulozenka_branch_<?php echo $branch->id; ?>">
...
<div class="zasielka_div2"  style="float: left; clear:right; max-width: 50%;margin:0; padding:0;">
  ...
  <div style="margin-top: 8px;">
   ...
   <br />
   <?php 
   $url = $detail_url = JURI::root().'plugins/vmshipment/ulozenka/detail_pobocky.php?id='.(string)$branch->id;
