...
<div id="header">
	...
	<div id="editcell">
		...
		<tr>
			...
			<th style="width: 20%; text-align: left;"><?php echo $this->sort('ju.name', 'COM_VIRTUEMART_USER_DISPLAYED_FIRSTNAME_LASTNAME'); ?></th>
			<th style="width: 20%;"><?php echo $this->sort('ju.email', 'COM_VIRTUEMART_EMAIL'); ?></th>
			<th style="width: 10%;"><?php echo $this->sort('ju.lastvisitDate', 'COM_VIRTUEMART_LAST_VISIT'); ?></th>
			...
			<th ><?php echo $this->sort('is_online', 'COM_VIRTUEMART_ON_LINE') ?></th>
		</tr>
		</thead>
		<?php
		$k = 0;
