...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td align="left"><strong>
                <?php $order_number = substr($this->orderDetails['details']['BT']->order_number, 4); echo $order_number; ?>
            </strong>
        </td>
    </tr>
...
<!--    </tr>-->
    ...
    <?php if ($this->orderDetails['details']['BT']->customer_note) { ?>
        <tr>
            <td style="color:#c4013d; font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_CUSTOMER_NOTE') ?></td>
    ...
    <tr>
        <td valign="top"><span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_BILL_TO_LBL') ?></span> <br/>
            <table border="0"><?php
        ...
        <td valign="top"><span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SHIP_TO_LBL') ?></span> <br/>
            <table border="0"><?php
