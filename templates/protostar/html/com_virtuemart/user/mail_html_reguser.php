		...
		<tr>
			<td>
				...
				<?php echo vmText::sprintf('COM_VIRTUEMART_WELCOME_USER', $this->user->name); ?>
							<br/>
				<?php echo vmText::_('COM_VIRTUEMART_LINK_ACTIVATE_ACCOUNT_TWO_ACTIONS'); ?>
				<?php
				if (!empty($this->activationLink)) {
					$activationLink = '1) <a class="default" href="' . JURI::root() . $this->activationLink . '">' . vmText::_('COM_VIRTUEMART_LINK_ACTIVATE_ACCOUNT') . '</a>';
					echo $li;
				...
				?>
					...
					<tr>
						<td>
							<?php echo vmText::_('COM_VIRTUEMART_LINK_ACTIVATE_ACCOUNT_SECOND_ACTION'); ?>
						</td>
					</tr>
				</table>
