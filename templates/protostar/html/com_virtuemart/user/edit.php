...
<?php if ($this->userDetails->virtuemart_user_id == 0) {
    ...
    echo '<h3 class="vm-USERS_LOGIN_REGISTER">' ;
    echo vmText::_('COM_VIRTUEMART_USERS_LOGIN_REGISTER');
    echo '</h3>' ;

    echo '<h2 class="register-title">' . vmText::_('COM_VIRTUEMART_YOUR_ACCOUNT_REG') . '</h2>';
} ?>

<form method="post" id="adminForm"  name="userForm" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user', $this->useXHTML, $this->useSSL) ?>" class="adminForm-custom form-validate">
