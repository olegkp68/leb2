                    ...
                    <div class="spacer-buy-area">
                        ...
                        <?php if ($this->product->prices['salesPrice'] <= 0 and VmConfig::get('askprice', 1) and isset($this->product->images[0]) and !$this->product->images[0]->file_is_downloadable) { ?>
                            ...
                            <div class="ask-a-question">
                                <a class="leb-btn" href="<?php echo $regurl ?>"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a>
                            </div>
                            <div class="clear"></div>
                        ...
                        if (VmConfig::get('ask_question', 0) == 1) {
                            ...
                            ?>
                            <div class="ask-a-question">
                                <a class="ask-a-question" href="<?php echo $askquestion_url ?>" rel="nofollow"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_ASKPRICE') ?></a>
                            </div>
                            <?php
                        }
                        ?>
