...
//        echo '<div class="vm-cart-price">' . vmText::_ ('COM_VIRTUEMART_CART_PRICE') . '</div>';
    ...
    if ($product->prices['salesPrice'] <= 0 and VmConfig::get('askprice', 1) and isset($product->images[0]) and !$product->images[0]->file_is_downloadable) {
        ...
        ?>
<!--        <a class="leb-btn enquiry-btn" href="--><?php //echo $product->link . $ItemidStr; ?><!--" rel="nofollow">--><?php //echo vmText::_('COM_VIRTUEMART_PRODUCT_ASKPRICE') ?><!--</a>-->
        ...
        //if ($showBasePrice) {
        if($product->prices['basePrice'] != $product->prices['priceWithoutTax']) { // Discount price modification
