            ...
            <div class="spacer">
                ...
                <?php if ($products_per_row >= 2) : ?>
                    <h2 class="leb-prod-title" rel="tooltip"
						...
						<!--<br>Артикул: <span style="color:#C4013D"><?php echo $product->product_sku ?></span> -->
                    </h2>
					<h2 class="leb-prod-title-sku"><br>Артикул: <span style="color:#C4013D"><?php echo $product->product_sku ?></span></h2>
