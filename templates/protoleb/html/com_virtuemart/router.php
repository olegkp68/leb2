	...
	switch ($view) {
		...
		case 'category';
			...
			if ($start !== null &&  $limitstart!== null ) {
				...
				//$segments[] = $helper->lang('results') .'_1-'.$start ;
			} else if ( $start>0 ) {
