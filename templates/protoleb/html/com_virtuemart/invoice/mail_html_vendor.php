...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
    <tr>
        <td>
            ...
            $order_number = substr($this->orderDetails['details']['BT']->order_number, 4);
            //echo '111' . $this->shopperName . '222';
            echo vmText::sprintf('COM_VIRTUEMART_MAIL_VENDOR_CONTENT', $this->vendor->vendor_store_name, $this->shopperName, $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total), $order_number);
