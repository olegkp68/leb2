...
<!-- <table class="html-email" width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
      <th align="left" colspan="2">
          <strong><?php //echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SHOPPER_INFO') ?></strong>
      </th>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_USER_DISPLAYED_NAME') ?></td>
    <td><?php //echo $this->shopperDetails->first_name ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_USERS_REGISTER_SURNAME_LABEL') ?></td>
    <td><?php //echo $this->shopperDetails->last_name ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_USERS_USER_FIELD_COMPANY_LABEL') ?></td>
    <td><?php //echo $this->shopperDetails->company ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_SHOPPER_FORM_ADDRESS_1') ?></td>
    <td><?php //echo $this->shopperDetails->address_1 ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_SHOPPER_FORM_CITY') ?></td>
    <td><?php //echo $this->shopperDetails->city ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_SHOPPER_FORM_ZIP') ?></td>
    <td><?php //echo $this->shopperDetails->zip ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_SHOPPER_FORM_COUNTRY') ?></td>
    <td><?php //echo $this->shopperDetails->country_name ?></td>
  </tr>
  <tr>
    <td><?php //echo vmText::_('COM_VIRTUEMART_SHOPPER_FORM_PHONE') ?></td>
    <td><?php //echo $this->shopperDetails->phone_1 ?></td>
  </tr>
...
<table class="html-email" width="100%" cellspacing="0" cellpadding="0" border="0">
    <!--<tr>
        <th align="left" colspan="9">
            <strong><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_INFO_STATUS') ?></strong>
        </th>
    </tr> -->
    <tr align="left" class="sectiontableheader">
        <td align="left" width="8%">
            <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SKU') ?></span>
        </td>
        <td align="left" colspan="3" width="28%">
            <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_NAME_TITLE') ?></span>
        </td>
        <!--        <td align="center" width="10%">-->
        <!--            <span style="font-weight: bold;">-->
        <?php //echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_STATUS') ?><!--</span>-->
        <!--        </td>-->
        <?php if ($this->doctype == 'invoice') { ?>
            <td align="right" width="14%">
                <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRICE') ?></span>
            </td>
        <?php } ?>
        <td align="right" width="8%">
            <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_QTY') ?></span>
        </td>
        <?php if ($this->doctype == 'invoice') { ?>
                ...
                <td align="right" width="10%">
                    <span style="font-weight: bold;"><?php
                        if (is_array($taxBill) and count($taxBill) == 1) {
                            ...
                            echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PAYMENT_TAX');
                        } else {
                            echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PAYMENT_TAX');
                        }
                        ?>
            ...
            <!--<td align="right" width="11%">
                <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SUBTOTAL_DISCOUNT_AMOUNT') ?></span>
            </td>-->
		        <td align="right" width="11%">
			        <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_CART_PRICE_NETTO') ?></span>
		        </td>
            <td align="right" width="11%">
                <span style="font-weight: bold;"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_BRUTTO') ?></span>
            </td>
        <?php } ?>
    </tr>
    ...
    foreach ($this->orderDetails['items'] as $item) {
        ...
        <tr valign="top">
            <td align="left">
                <a href="<?php echo $product_link; ?>"><?php echo $item->order_item_sku; ?></a>
            </td>
            ...
            <?php if ($this->doctype == 'invoice') { ?>
                <td align="right" class="priceCol">
                    ...
                    if (!empty($item->product_priceWithoutTax) && $item->product_discountedPriceWithoutTax != $item->product_priceWithoutTax) {
                        ...
                        echo '<span class="discountedPriceWithoutTax">' . $this->currency->priceDisplay($item->product_discountedPriceWithoutTax, $this->user_currency_id) . '</span><br />';
                    }
                    ?>
                </td>
            <?php } ?>
            ...
            <?php if ($this->doctype == 'invoice') { ?>
	            ...
	            <td align="right" class="priceCol">
	              <?php echo '<span class="discountedPriceWithoutTax">' . $this->currency->priceDisplay($item->product_discountedPriceWithoutTax, $this->user_currency_id, $qtt) . '</span>'; ?>
	            </td>
                <td align="right" class="priceCol">
                    <?php
    ...
    <?php if ($this->doctype == 'invoice') { ?>
      ...
      <!--  <tr class="sectiontableentry1">
            ...
            <?php } ?>
            <td align="right"><?php echo "<span  class='priceColor2'>" . $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_subtotal, $this->user_currency_id) . "</span>" ?></td>
        ...
        if ($this->orderDetails['details']['BT']->coupon_discount <> 0.00) {
            ...
            ?>
            <tr>
                <td align="right" class="pricePad" colspan="7"><?php echo vmText::_('COM_VIRTUEMART_COUPON_DISCOUNT') . $coupon_code ?></td>
                <?php if (VmConfig::get('show_tax')) { ?>
                    <td align="right"></td>
                <?php } ?>
                <td align="right"></td>
        ...
        if ($discountsBill) {
            foreach ($discountsBill as $rule) { ?>
                <tr>
                    <td colspan="7" align="right" class="pricePad"><?php echo $rule->calc_rule_name ?> </td>
                    <?php if (VmConfig::get('show_tax')) { ?>
                        <td align="right"></td>
                    <?php } ?>
        ...
        <tr class="sectiontableentry1">
            ...
            <?php if (VmConfig::get('show_tax')) { ?>
                <td align="right">
                    <span class='priceColor2'><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_billTaxAmount, $this->user_currency_id); ?></span>
                </td>
            <?php } ?>
            <td align="right">
                <span class='priceColor2'><?php echo $this->currency->priceDisplay($this->orderDetails['details']['BT']->order_subtotal, $this->user_currency_id); ?></span>
            </td>
            <td align="right">
        ...
        if (!empty($this->orderDetails['details']['BT']->payment_currency_rate)
            ...
            <tr>
                <td align="right" class="pricePad" colspan="6">
                    <strong><?php echo vmText::_('COM_VM_TOTAL_IN_PAYMENT_CURRENCY') ?></strong>
                </td>
        ...
        if ($taxBill) {
            ?>
            <tr>
            <td colspan="6" align="right" class="pricePad"><?php echo vmText::_('COM_VIRTUEMART_TOTAL_INCL_TAX') ?> </td>
            <td></td>
            <td></td>
            </tr><?php
            foreach ($taxBill as $rule) {
                if ($rule->calc_kind == 'taxRulesBill' or $rule->calc_kind == 'VatTax') { ?>
                    <tr>
                        <td colspan="5" align="right" class="pricePad"><?php echo $rule->label ?> </td>
                        <?php if (VmConfig::get('show_tax')) { ?>
