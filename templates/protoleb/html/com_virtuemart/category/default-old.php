    ...
    if ($this->showproducts) {
        ...
        <div class="browse-view">
            ...
            if (!empty($this->keyword)) {
                ...
                <h3><?php echo vmText::_('COM_FINDER_DEFAULT_PAGE_TITLE') ?>&nbsp;<?php echo $this->keyword; ?></h3>
...
<!--                        <input name="keyword" id="keyword_search" class="inputbox" type="text" size="20" value="--><?php //echo $this->keyword ?><!--"/>-->
...
<!--                </form>-->
            ...
            <div class="orderby-displaynumber">
                ...
                <!--                    <br/>-->
                <?php //echo $this->vmPagination->getLimitBox($this->category->limit_list_step); ?><!--</div>-->
